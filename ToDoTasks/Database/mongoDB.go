...
var dbAddress, dbName = getDatabaseCredentials("C:\\GolangProjects\\toDoTasks\\Credentials.json")
...
type Credentials struct {
	DB_Address  string `json:"dbAddress"`
...
func getDatabaseCredentials(jsonCredFile string) (string, string) {
	...
	return credentials.DB_Address, credentials.DB_Name
}
...
func CreateTask(w http.ResponseWriter, r *http.Request) {
	...
	var task taskFunctions.ToDoTask
...
func insertOneTask(task taskFunctions.ToDoTask) {
